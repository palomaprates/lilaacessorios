            ...
            <div className="grid md:grid-cols-2 grid-cols-1 md:mx-30 justify-center pt-10 gap-10">
              <div className="flex flex-col text-center mx-6">
                ...
                <p className="text-sm leading-relaxed flex items-center">
                  Localizadas em Sintra, uma vila encantadora conhecida pelos
                  seus palácios e atmosfera única que atrai visitantes do mundo
                  inteiro, duas das nossas três lojas reúnem, junto com toda a
                  magia do lugar, acessórios cheios de personalidade e
                  significado — peças escolhidas a dedo para combinar com o
                  charme e a energia especial de Sintra.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 md:mx-30 justify-center pt-10 gap-10">
              <div className="flex flex-col text-center mx-6">
                ...
                <p className="text-sm leading-relaxed flex items-center">
                  ...
                  Entre o charme das ruas de calçada portuguesa e a brisa
                  salgada do Atlântico, oferecemos acessórios que refletem o
                  estilo de vida surfista, livre e autêntico que só a Ericeira
                  tem — peças com a cara do verão o ano todo.
                </p>
              </div>
              <div className="flex justify-center mx-6 md:mx-0 items-start">
                <iframe
